...
class FullHouse extends Rule {
  evalRoll = dice => {
    ...
    return (freqs[0] === 2 && freqs[1] === 3) || (freqs[0] === 3 && freqs[1] === 2) ? this.score : 0;
  };
}
...
class SmallStraight extends Rule {
  ...
  evalRoll = dice => {
    ...
    // 2 3 4 5
    // 3 4 5 6
    return (d.size >= 4 && d.has(3) && d.has(4)) && (((d.has(2) && d.has(1)) || (d.has(5) && d.has(6)) || (d.has(2) && d.has(5)))) ? this.score : 0;
  };
}
