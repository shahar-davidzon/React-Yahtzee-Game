...
class ScoreTable extends Component {
  getTotalScore = () => {
    ...
    if (Object.keys(scores).every(k => scores[k] !== undefined)) {
  ...
  render() {
    ...
    return (
      <div className="ScoreTable">
        ...
        <h2 className='score'>TOTAL SCORE: {this.getTotalScore()}</h2>
        <h2 className='score'>BEST SCORE: {localStorage.getItem('score')}</h2>
      </div>
    )
  }
}
